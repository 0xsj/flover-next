...
try {
  let all = false, changed = false, base;
  ...
  console.log(json ? JSON.stringify(failure) : `NOT_CHECKED — ${failure.message}`);
  process.exitCode = 2;
}
