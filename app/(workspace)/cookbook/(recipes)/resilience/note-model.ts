import { createSaveDraft, type DraftPhase, type DraftPort, type DraftState } from "@/lib/runtime/save-draft";
...
export function createNoteModel(port: DraftPort<NoteAttempt, NoteReceipt>, initial: NoteDraft, newId = () => crypto.randomUUID()) {
  return createSaveDraft(port, initial, {
    same: sameDraft, newId,
