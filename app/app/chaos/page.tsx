...
export const metadata: Metadata = { title: "Chaos · flover" };
 ...
 *
 * `/app/failures` is the other half and a different question: that one dissects
      ...
      <Flex direction="column" gap={7}>
        ...
        <Panel title="Where to look while it is on">
          ...
          <p className={s.meta}>
            ...
            <Link href="/app/failures">Failures</Link>.
          </p>
        </Panel>
      </Flex>
    </Container>
