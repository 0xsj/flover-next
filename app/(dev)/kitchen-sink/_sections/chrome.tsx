  ...
  return (
    ...
    >
      <Case title="ThemeToggle" note="three states, and system is one of them">
        <Row label="control"><ThemeToggle /></Row>
        <p className={s.limits}>
          ...
          to change when their OS does, and a user who picked{" "}
          <code>light</code> wants it not to. A switch cannot hold that
        ...
        <p className={s.limits}>
          ...
          on/off states when the truth is one choice with three answers — one Tab
          stop rather than three, and a reader told how many decisions are in
          front of them.
        </p>
      </Case>

      <Case title="DensityToggle" note="a token override, and this page is where it shows">
        <Row label="control"><DensityToggle /></Row>
        <Row label="what moves">
          <Flex gap={4} align="center">
            <Button size="sm">Small</Button>
            <Button>Medium</Button>
            <Input placeholder="Control height" className={s.selectWidth} />
          </Flex>
        </Row>
        <p className={s.limits}>
          ...
          <strong>a component that hard-coded a height is visibly wrong the
          moment this is switched</strong>, and this page is where you would see
          it.
        </p>
        <p className={s.limits}>
      ...
      <Case title="Mark" note="the element is the caller's fact; the spelling is not">
        <Row label="inline"><Mark /></Row>
        <Row label="display">
          <Box><Mark as="h2" size="display" /></Box>
        </Row>
        <p className={s.limits}>
        ...
        <p className={s.limits}>
          ...
          <code>{MARK}</code>, spelled once — and <code>asChild</code> would mean
          writing it at every call site, which is the duplication this ends. The
          two rules it replaced lived in two route stylesheets.
        </p>
      </Case>

      <Case title="The flash, and the one script that runs first" note="not fixable inside a component">
        <p className={s.limits}>
        ...
        <pre className={s.codeBlock}><code>{RUNTIME_BOOT_SCRIPT}</code></pre>
        <p className={s.limits}>
