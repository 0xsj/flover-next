...
export function FeedbackSection() {
  return (
    ...
    >
      <Case title="Alert" note="live is absent by default, because most alerts are rendered with the page">
        <Row label="tones">
          <Box className={s.fullWidth}>
            <Flex direction="column" gap={4}>
              ...
              <Alert tone="warn" title="Rate limited" action={<Button size="sm">Retry</Button>}>
      ...
      <Case title="Skeleton" note="hidden from readers, and sized to what is coming">
        <Row label="text">
          <Box className={s.fullWidth}><SkeletonText lines={3} /></Box>
        </Row>
        <Row label="a shape">
          <Panel title="Targets">
            <div aria-busy="true">
              <Flex gap={5} align="center" py={2}>
                ...
                <Box className={s.fullWidth}><SkeletonText lines={2} /></Box>
              </Flex>
            </div>
          </Panel>
        </Row>
          ...
          <Panel title="Targets">
            <Flex gap={5} align="center" py={2}>
              ...
              <div>
                ...
                <div className={s.quiet}>Owned by Ada Lovelace</div>
              </div>
            </Flex>
          </Panel>
        </Row>
