...
export function ShellsSection() {
  return (
    ...
    >
      ...
      <Case title="SidebarNav" note="the one group that takes data instead of slots">
        <Row label="on /app">
          <div className={s.navWidth}><SidebarNav groups={groups} current="/app" /></div>
        </Row>
        <Row label="on a nested route">
          <div className={s.navWidth}>
        ...
        <p className={s.limits}>
          ...
          not just a different colour. Matching is by{" "}
