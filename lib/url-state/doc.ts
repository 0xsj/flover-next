 ...
 * keys and infers its state type. It knows no route, router, browser, or React.
 *
 ...
 *
 * The Next binding reads useSearchParams and uses native pushState/replaceState
 ...
 * updates without a stale React closure. Browser back/forward drives the same
