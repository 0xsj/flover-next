...
const SEED: ReadonlyArray<Omit<RecordInput, "correlationId"> & { correlationId: string; agoMinutes: number }> = [
  { scope: "account", action: "account.created", subject: "ada@example.com", actor: "anonymous", correlationId: "cid-seed-01", detail: { via: "sign-up" }, agoMinutes: 60 * 74 },
  { scope: "session", action: "session.signed_in", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-01", detail: { device: "MacBook Pro" }, agoMinutes: 60 * 74 },
  { scope: "account", action: "account.email_verified", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-02", detail: {}, agoMinutes: 60 * 72 },
  { scope: "session", action: "session.signed_out", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-03", detail: {}, agoMinutes: 60 * 71 },
  { scope: "session", action: "session.sign_in_failed", subject: "ada@example.com", actor: "anonymous", correlationId: "cid-seed-04", detail: { reason: "wrong_password", attempt: 1 }, agoMinutes: 60 * 50 },
  { scope: "session", action: "session.sign_in_failed", subject: "ada@example.com", actor: "anonymous", correlationId: "cid-seed-04", detail: { reason: "wrong_password", attempt: 2 }, agoMinutes: 60 * 50 },
  { scope: "session", action: "session.signed_in", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-05", detail: { device: "iPhone" }, agoMinutes: 60 * 49 },
  { scope: "account", action: "account.password_changed", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-06", detail: {}, agoMinutes: 60 * 30 },
  { scope: "session", action: "session.revoked", subject: "ses_older", actor: "ada@example.com", correlationId: "cid-seed-06", detail: { device: "iPhone" }, agoMinutes: 60 * 30 },
  { scope: "system", action: "system.rate_limit_applied", subject: "ada@example.com", actor: "system", correlationId: "cid-seed-07", detail: { window: "30s", endpoint: "POST /auth/sign-in" }, agoMinutes: 60 * 26 },
  { scope: "system", action: "system.fixture_seeded", subject: "flover", actor: "system", correlationId: "cid-seed-08", detail: { note: "the memory adapter started" }, agoMinutes: 60 * 24 },
  { scope: "session", action: "session.expired", subject: "ses_stale", actor: "system", correlationId: "cid-seed-09", detail: { ttl_minutes: 30 }, agoMinutes: 60 * 6 },
  { scope: "account", action: "account.profile_updated", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-10", detail: { fields: ["name"] }, agoMinutes: 60 * 5 },
  { scope: "session", action: "session.signed_in", subject: "ada@example.com", actor: "ada@example.com", correlationId: "cid-seed-11", detail: { device: "Firefox on Linux" }, agoMinutes: 90 },
];
