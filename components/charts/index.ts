...
export { categorical, CATEGORICAL, SHAPES, radiusFor, sequentialFill, divergingFill, shapePath } from "./_kernel/encode";
export type { MarkShape, LegendItem } from "./_kernel/encode";
export { linear, band, diverging, extentOf, pad, niceTicks } from "./_kernel/scale";
